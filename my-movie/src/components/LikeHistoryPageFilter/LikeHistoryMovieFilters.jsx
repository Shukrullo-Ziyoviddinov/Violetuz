...
/** Kino filterlari — wishlist movie panel bilan bir xil ishlash */
const LikeHistoryMovieFilters = ({ movies = [], draft, onChange }) => {
  ...
  return (
    <div className="like-history-filter-panel like-history-filter-panel--movie">
      <div className="like-history-filter-section">
        <h4 className="like-history-filter-section-title">{t('detail.rating')}</h4>
      ...
      <div className="like-history-filter-section">
        <h4 className="like-history-filter-section-title">
...
export default LikeHistoryMovieFilters;
