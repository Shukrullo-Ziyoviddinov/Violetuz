    ...
    <>
      ...
      >
        ...
        <div className="profile-info-modal-body">
          ...
          <button
            type="button"
            className="profile-wishlist-block profile-info-action profile-info-action--logout"
      ...
      <GlobalModal
        ...
        title="Chindan ham hisobdan chiqmoqchimi siz?"
      >
        <div className="profile-logout-confirm">
          <div className="profile-logout-confirm-actions">
            <button
              type="button"
              className="profile-logout-confirm-btn profile-logout-confirm-btn--no"
            ...
            <button
              type="button"
              className="profile-logout-confirm-btn profile-logout-confirm-btn--yes"
