...
import ArtistDetailElementFilter, { FILTER_ALL, FILTER_MUSIC, FILTER_ALBUM, FILTER_KLIP, FILTER_SHORTS, FILTER_KONSERT } from '../Music/ArtistDetailElementFilter/ArtistDetailElementFilter';
  ...
  return (
    <div className="artist-detail">
      <div className="artist-detail-container">
        ...
        {(artistTracks.length > 0 || artistAlbums.length > 0 || artistClips.length > 0 || artistShorts.length > 0 || artistConcerts.length > 0) && (
